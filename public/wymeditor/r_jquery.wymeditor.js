...
*/
  ...
  BLOCKS: new Array("address", "blockquote", "div", "dl", "fieldset", "form", "h1", "h2", "h3", "h4", "h5", "h6", "hr", "noscript", "ol", "p", "pre", "table", "ul", "dd", "dt", "li", "tbody", "td", "tfoot", "th", "thead", "tr", "meter", "section", "article", "aside", "details", "header", "footer", "nav", "dialog", "figure", "figcaption", "address", "hgroup", "mark", "time", "canvas", "audio", "video", "source", "output", "progress", "ruby", "rt", "rp", "summary", "command"),
...
$.fn.wymeditor = function(options) {
  ...
  options = $.extend({
    ...
    classesItemHtml: "<li class='wym_classes_" + WYMeditor.CLASS_NAME + "'>" + "<a href='#' name='" + WYMeditor.CLASS_NAME + "'>" + WYMeditor.CLASS_TITLE + "</a>" + "</li>",
    ...
    dialogLinkHtml: "<div class='wym_dialog wym_dialog_link'>" + "<form>" + "<fieldset>" + "<input type='hidden' id='wym_dialog_type' class='wym_dialog_type' value='" + WYMeditor.DIALOG_LINK + "' />" + "<legend>{Link}</legend>" + "<div class='row'>" + "<label>{URL}</label>" + "<input type='text' class='wym_href' value='' size='40' />" + "</div>" + "<div class='row'>" + "<label>{Title}</label>" + "<input type='text' class='wym_title' value='' size='40' />" + "</div>" + "<div class='row row-indent'>" + "<input class='wym_submit button' type='button'" + " value='{Submit}' />" + "<input class='wym_cancel' type='button'" + "value='{Cancel}' />" + "</div>" + "</fieldset>" + "</form>" + "</div>",

    dialogImageHtml: "<div class='wym_dialog wym_dialog_image'>" + "<form>" + "<fieldset>" + "<input type='hidden' id='wym_dialog_type' class='wym_dialog_type' value='" + WYMeditor.DIALOG_IMAGE + "' />" + "<legend>{Image}</legend>" + "<div class='row'>" + "<label>{URL}</label>" + "<input type='text' class='wym_src' value='' size='40' />" + "</div>" + "<div class='row'>" + "<label>{Alternative_Text}</label>" + "<input type='text' class='wym_alt' value='' size='40' />" + "</div>" + "<div class='row'>" + "<label>{Title}</label>" + "<input type='text' class='wym_title' value='' size='40' />" + "</div>" + "<div class='row row-indent'>" + "<input class='wym_submit button' type='button'" + " value='{Submit}' />" + "<input class='wym_cancel' type='button'" + "value='{Cancel}' />" + "</div>" + "</fieldset>" + "</form>" + "</div>",

    dialogTableHtml: "<div class='wym_dialog wym_dialog_table'>" + "<form>" + "<input type='hidden' id='wym_dialog_type' class='wym_dialog_type' value='" + WYMeditor.DIALOG_TABLE + "' />" + "<div class='row'>" + "<label>{Caption}</label>" + "<input type='text' class='wym_caption' value='' size='40' />" + "</div>" + "<div class='row'>" + "<label>{Summary}</label>" + "<input type='text' class='wym_summary' value='' size='40' />" + "</div>" + "<div class='row'>" + "<label>{Number_Of_Rows}</label>" + "<input type='text' class='wym_rows' value='3' size='3' />" + "</div>" + "<div class='row'>" + "<label>{Number_Of_Cols}</label>" + "<input type='text' class='wym_cols' value='2' size='3' />" + "</div>" + "<div class='row row-indent'>" + "<input class='wym_submit button' type='button'" + " value='{Submit}' />" + "<input class='wym_cancel' type='button'" + "value='{Cancel}' />" + "</div>" + "</form>" + "</div>",

    dialogPasteHtml: "<div class='wym_dialog wym_dialog_paste'>" + "<form>" + "<input type='hidden' id='wym_dialog_type' class='wym_dialog_type' value='" + WYMeditor.DIALOG_PASTE + "' />" + "<fieldset>" + "<legend>{Paste_From_Word}</legend>" + "<div class='row'>" + "<textarea class='wym_text' rows='10' cols='50'></textarea>" + "</div>" + "<div class='row'>" + "<input class='wym_submit button' type='button'" + " value='{Submit}' />" + "<input class='wym_cancel' type='button'" + "value='{Cancel}' />" + "</div>" + "</fieldset>" + "</form>" + "</div>",
...
WYMeditor.editor.prototype.init = function() {
  ...
  if (WymClass) {
    ...
    if ($.isFunction(this._options.preInit)) {
    ...
    boxHtml = h.replaceAll(boxHtml, ">" + WYMeditor.APPLY_CLASS + "<", ">" + this._options.stringDelimiterLeft + WYMeditor.APPLY_CLASS + this._options.stringDelimiterRight + "<");
    ...
    if (oClass == null) {
      $.each(aClasses, function(index, classRule) {
        if (oClass == null && classRule.rules && classRule.rules.length > 0) {
          ...
          if (indexOf != null) oClass = {
            expr: (classRule.rules[indexOf].expr || null)
          };
        }
      });
    }
...
WYMeditor.editor.prototype.container = function(sType) {
  ...
  if (sType) {
    ...
    if (sType.toLowerCase() == WYMeditor.TH) {
      ...
      var aTypes = new Array(WYMeditor.P, WYMeditor.H1, WYMeditor.H2, WYMeditor.H3, WYMeditor.H4, WYMeditor.H5, WYMeditor.H6, WYMeditor.PRE, WYMeditor.BLOCKQUOTE);
...
WYMeditor.editor.prototype.toggleClass = function(sClass, jqexpr) {
  ...
  if (!container.attr(WYMeditor.CLASS)) {
    container.removeAttr(this._class);
  }
...
WYMeditor.editor.prototype.toggleClassSelector = function() {
  ...
  var wym = this;
  var disabled = $(wym._box).find(wym._options.classUnhiddenSelector).hasClass(wym._options.classHiddenSelector.substring(1));
  if (disabled) {
    $(wym._box).find(wym._options.classUnhiddenSelector).removeClass(wym._options.classHiddenSelector.substring(1));

    $(wym._box).find("a[name=" + WYMeditor.APPLY_CLASS + "]").addClass('selected').parent().addClass('activated');
  } else {
    $(wym._box).find(wym._options.classUnhiddenSelector).addClass(wym._options.classHiddenSelector.substring(1));

    $(wym._box).find("a[name=" + WYMeditor.APPLY_CLASS + "]").removeClass('selected').parent().removeClass('activated');
  }
...
WYMeditor.editor.prototype.dialog = function(dialogType) {
  ...
  ajax_loaded_callback = function() {
    wym.dialog_ajax_callback(selected);
  };
      ...
      if (wym._selected_image == null) {
        if (selected != null && selected.tagName.toLowerCase() != WYMeditor.A && wym._iframe.contentWindow.getSelection) {
          ...
          if (selection.focusNode.insertData) {
            ...
            $(selected).html($(selected).html().replace(start_tag, "<span id='" + wym._current_unique_stamp + "'>").replace(end_tag, "</span>"));
          } else {
  ...
  if (container && container.tagName.toLowerCase() != WYMeditor.BODY) {
    ...
    for (x = aP.length - 1; x >= 0; x--) {
      ...
      if (x == 0) {
        ...
        if (aP.length > 1 && $(container).get(0).tagName.toLowerCase() == "span" && $(container).attr('id') == ('' + wym._current_unique_stamp) && $(container).parent().get(0).tagName.toLowerCase() == "p") {
          p = $(container).parent();
...
WYMeditor.editor.prototype.loadSkin = function() {
  ...
  if (this._options.loadSkin && !WYMeditor.SKINS[this._options.skin]) {
    ...
    if (!found) WYMeditor.loadCss(this._options.skinPath + WYMeditor.SKINS_DEFAULT_CSS);
  }
...
WYMeditor.INIT_DIALOG = function(wym, selected, isIframe) {
  ...
  $(wym._options.dialogLinkSelector).find(wym._options.submitSelector).click(function(e) {
    if ((sUrl = $(wym._options.hrefSelector).val()).length > 0) {
      if (replaceable.get(0) != null) {
        var link = $('<a></a>').attr({
          href: sUrl,
          title: $(wym._options.titleSelector).val()
        })
        ...
        if (!wym._selected_image) {
          ...
          link.attr({
            'style': replaceable.attr('style'),
            'class': replaceable.attr('class')
          });
        ...
        $("a[href=" + wym._current_unique_stamp + "]", wym._doc.body).attr(WYMeditor.HREF, sUrl).attr(WYMeditor.TITLE, $(wym._options.titleSelector).val()).attr(WYMeditor.TARGET, $(wym._options.targetSelector).val());
      }
    }
  ...
  $(wym._options.dialogImageSelector).find(wym._options.submitSelector).click(function(e) {
    ...
    if ((url = form.find(wym._options.srcSelector).val()) != null && url.length > 0) {
      (image = $(wym._doc.createElement("IMG"))).attr(WYMeditor.SRC, url).attr(WYMeditor.TITLE, form.find(wym._options.titleSelector).val()).attr(WYMeditor.ALT, form.find(wym._options.titleSelector).val()).attr(WYMeditor.REL, form.find(wym._options.sizeSelector).val()).load(function(e) {
        $(this).attr({
          'width': $(this).width(),
          'height': $(this).height()
        });
...
WYMeditor.editor.prototype.close_dialog = function(e, cancelled) {
  if (cancelled) {
    ...
    } (remove_id = $(this._doc.body).find('#' + this._current_unique_stamp)).attr('id', (remove_id.attr('_id_before_replaceable') || "")).replaceWith(remove_id.html());
...
WYMeditor.XhtmlValidator = {
  "_attributes": {
    "core": {
      ...
      "attributes": ["class", "id", "style", "title", "accesskey", "tabindex", "data", "^data-.*"]
    },
    "language": {
  ...
  "_tags": {
    ...
    "23": "i",
    "iframe": {
      "attributes": ["src", "width", "height", "frameborder", "scrolling", "marginheight", "marginwidth"],
      "required": ["src"]
    },
    "img": {
      "attributes": {
    ...
    "embed": {
      "attributes": ["width", "height", "allowfullscreen", "allowscriptaccess", "wmode", "type", "src", "flashvars"],
      "inside": "object"
    },
    "object": {
  ...
  doesAttributeNeedsValidation: function(tag, attribute) {
    return this._tags[tag] && ((this._tags[tag]['attributes'] && this._tags[tag]['attributes'][attribute]) || (this._tags[tag]['required'] && WYMeditor.Helper.contains(this._tags[tag]['required'], attribute)));
  },
  validateAttribute: function(tag, attribute, value) {
    if (this._tags[tag] && (this._tags[tag]['attributes'] && this._tags[tag]['attributes'][attribute] && value.length > 0 && !value.match(this._tags[tag]['attributes'][attribute])) || // invalid format
...
WYMeditor.XhtmlSaxListener.prototype._getClosingTagContent = function(position, tag) {
  if (this['_insert_' + position + '_closing'] && this['_insert_' + position + '_closing'][tag] && this['_insert_' + position + '_closing'][tag].length > 0) {
...
WYMeditor.WymCssParser.prototype.WymCssComment = function(text, status) {
  ...
  if (status == WYMeditor.LEXER_UNMATCHED) {
    if (!this._in_style) {
      ...
      this._current_item = {
        'title': WYMeditor.Helper.trim(text)
      };
    } else {
...
WYMeditor.WymCssParser.prototype.WymCssStyleDeclaration = function(match) {
  ...
  if (!this._has_title) {
    this._current_item = {
      'title': (!tag ? '' : tag.toUpperCase() + ': ') + this._current_element
    };
    this._has_title = true;
  }
...
$.fn.parentsOrSelf = function(jqexpr) {
  ...
  if (n[0].nodeType == 3) n = n.parents().slice(0, 1);

  //  if (n.is(jqexpr)) // XXX should work, but doesn't (probably a jQuery bug)
  if (n.filter(jqexpr).size() == 1) return n;
  else return n.parents(jqexpr).slice(0, 1);
};
...
WYMeditor.WymClassExplorer.prototype._exec = function(cmd, param) {
  ...
  case WYMeditor.OUTDENT:
    ...
    if (container) {
      ...
      if (container.parentNode.childNodes.length > 1 || ancestor.tagName.toLowerCase() == WYMeditor.OL || ancestor.tagName.toLowerCase() == WYMeditor.UL) this._doc.execCommand(cmd);
    }
    break;
  default:
...
WYMeditor.WymClassMozilla.prototype.html = function(html) {
  ...
  if (typeof html === 'string') {
    ...
    //(designMode issue)
    html = html.replace(/<em(\b[^>]*)>/gi, "<i$1>").replace(/<\/em>/gi, "</i>").replace(/<strong(\b[^>]*)>/gi, "<b$1>").replace(/<\/strong>/gi, "</b>");
...
WYMeditor.WymClassMozilla.prototype._exec = function(cmd, param) {
  ...
  case WYMeditor.OUTDENT:
    ...
    if (focusNode && focusNode == anchorNode && focusNode.tagName.toLowerCase() == WYMeditor.LI) {
      ...
      if (focusNode.parentNode.childNodes.length > 1 || ancestor.tagName.toLowerCase() == WYMeditor.OL || ancestor.tagName.toLowerCase() == WYMeditor.UL) this._doc.execCommand(cmd, '', null);
    }
    break;
  ...
  if (container.tagName.toLowerCase() == WYMeditor.BODY) this._exec(WYMeditor.FORMAT_BLOCK, WYMeditor.P);
};
...
WYMeditor.WymClassMozilla.prototype.selected = function(upgrade_text_nodes) {
  ...
  if (upgrade_text_nodes == null || upgrade_text_nodes.toString() != "true") {
    upgrade_text_nodes = false;
  }
  var sel = this._iframe.contentWindow.getSelection();
...
WYMeditor.WymClassOpera.prototype.keydown = function(e) {
  ...
  if (!$(startNode).parentsOrSelf(WYMeditor.MAIN_CONTAINERS.join(","))[0] && !$(startNode).parentsOrSelf('li') && e.keyCode != WYMeditor.KEY.ENTER && e.keyCode != WYMeditor.KEY.LEFT && e.keyCode != WYMeditor.KEY.UP && e.keyCode != WYMeditor.KEY.RIGHT && e.keyCode != WYMeditor.KEY.DOWN && e.keyCode != WYMeditor.KEY.BACKSPACE && e.keyCode != WYMeditor.KEY.DELETE) wym._exec(WYMeditor.FORMAT_BLOCK, WYMeditor.P);
