WYMeditor.SKINS['machete'] = {
    ...
    init: function(wym) {
        ...
        jQuery(wym._options.containersSelector + ', .wym_classes_container', wym._box)
          .appendTo( jQuery("div.wym_area_top", wym._box) );
        jQuery(wym._options.classesSelector, wym._box)
          .addClass("wym_dropdown");

        jQuery('.wym_classes_container').click(function(e){e.preventDefault();});

        jQuery(wym._options.containersSelector, wym._box).insertBefore(
          jQuery(wym._box).find(wym._options.toolsSelector));
